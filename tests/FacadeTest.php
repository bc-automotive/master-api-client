...
class FacadeTest extends TestCase
{
    ...
    public function facade_endecryption_test()
    {
        ...
        // Test2: decrypt.
        $dec = MasterApiClient::decrypt($enc['data']);
     ...
     * @test
     */
    public function facade_auth_failed_test()
    {
     ...
     * @test
     */
    public function facade_auth_failed2_test()
    {
        $this->expectException(ClientException::class);
        
        $dec = MasterApiClient::decrypt(random_bytes(256));
    }
